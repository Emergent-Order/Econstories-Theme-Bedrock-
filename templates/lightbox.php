<div id="lightbox-container" class="" data-remodal-id="lightbox">
	<div id="lightbox-content" >
		<button data-remodal-action="close" class="remodal-close"></button>
		<div id="lightbox-oembed-container"></div>
			...
			<article class="extra-credit type-extra-credit status-publish category-extra-credit entry">
	 			<a id="lightbox-affiliate-url" href="" target="_blank">
		 			...
		 			<header class="entry-header">
		 				<h2 class="entry-title widont"></h2>
...
<div id="whomadethis-lightbox" data-remodal-id="whomadethis">
	<button data-remodal-action="close" class="remodal-close"></button>
	<div class="header">
