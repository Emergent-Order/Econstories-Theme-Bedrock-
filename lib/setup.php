...
function widgets_init() {
  ...
  register_sidebar([
    'name'          => __('Email Capture Bar', 'sage'),
    'id'            => 'sidebar-email',
    'before_widget' => '<section class="widget %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<h3>',
 ...
 */
function assets() {
  wp_enqueue_style('bower/css', Assets\asset_path('styles/bower.css'), true, null);
  ...
  wp_enqueue_script('econ/js', Assets\asset_path('scripts/main.js'), ['jquery'], null, true);
